$(document).ready(function() {
	...
	==============================================*/
    if ($(window).scrollTop() <= 0 && $(window).width() >= 1202) {
        $('#main-nav').removeClass('scrolled');
        $('#home').removeClass('arqtop_scrollto');
       $('#logo-text').show();

	}
	else{
        $('#main-nav').addClass('scrolled');
        $('#home').addClass('arqtop_scrollto');
        $('#logo-text').hide();
	}
	...
	if ($(window).width() >= 1202) {
	    $('#main-nav').removeClass('scrolled');
	    $('#home').removeClass('arqtop_scrollto');
	    $('#home').addClass('arqtop');
        $('#logo-text').show();

	} else {
	    $('#main-nav').addClass('scrolled');
	    $('#home').removeClass('arqtop');
	    $('#home').addClass('arqtop_scrollto');
        $('#logo-text').hide();
	}
...
//            $('#logo-min').show();
	...
	//$.backstretch('Content/Themes/DesignR/assets/header-bg.jpg');

	//$('body').append('<img class="preload-image" src="Content/Themes/DesignR/assets/contact-bg.jpg" style="display:none;"/>');
	...
	//	if (direction=='down'){
	//	    $.backstretch('Content/Themes/DesignR/assets/contact-bg.jpg');
	//	}else{
	//	    $.backstretch('Content/Themes/DesignR/assets/header-bg.jpg');
	//	}
	//});
